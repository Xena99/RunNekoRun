 ...
 */
UCLASS()
class RUNNEKORUN_API UFindPlayerLocation_BTTask : public UBTTask_BlackboardBase
{
	GENERATED_BODY()

public:
	explicit UFindPlayerLocation_BTTask(FObjectInitializer const& ObjectInitializer);
